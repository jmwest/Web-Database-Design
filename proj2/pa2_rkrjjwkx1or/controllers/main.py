...
def main_route():
	...
	if session_status:
		...
		for id in list_of_ids_user_has_access_to:
			...
			print "the list of private albums user has access to is this: "
			print list_of_private_albums_user_has_access_to
